...
public class Level
{
    ...
    public Bush[] getbushes(int i)
    {
        switch (i) {
            ...
            case 5:
                bushes=new Bush[25];
                locationx = new int[]{120,100,167,50,160,195,290,400,350,300,530,234,433,324,534,123,234,231,435,234,535,342,123,213,33};
                locationy = new int[]{240,80, 110,30,300,330,200,100,170,30,200,530,234,433,324,534,123,234,231,435,234,535,342,123,213,33};
                bushheight=new int[]{30, 30, 70, 30,30, 50, 100, 140,30, 35,150,30, 30, 70, 30,30, 50, 100, 140,30, 35,150,30, 35,150};
                bushwidth =new int[]{170,100,33, 70,90, 30, 30, 30, 120,150,30,170,100,33, 70,90, 30, 30, 30, 120,150,30, 120,150,30};
                break;
            default:
                break;
        }
